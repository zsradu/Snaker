...
/// <summary>
/// After eating first enemy, the clone doesn't appear on the second position, but on the third
/// and there is nothing on the second.
/// After eating the second enemy, clones appear in positions 2 and 4, thus having length 4 instead of 3.
/// After that it is normal, just one clone appears at the end, but I always have one more unit than the actual length.
/// </summary>

public class Player_Lengthv1_0_0 : MonoBehaviour
{
